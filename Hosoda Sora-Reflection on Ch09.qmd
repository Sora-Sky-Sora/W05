...
> Accuracy alone does not describe this model very well because the response rate is low. ROC AUC summarizes performance across different thresholds, while sensitivity focuses on customers who actually respond. Together, these measures provide a clearer picture of model performance for a direct-mail campaign.
